...
- [ ] Features
  ...
  - [ ] Write Operations
    ...
    - [ ] Delete a book's page [#51](https://github.com/deepanchal/dnote-tui/issues/51)
    - [ ] Delete a book and all its pages [#52](https://github.com/deepanchal/dnote-tui/issues/52)
  ...
  - [ ] Misc (Nice to have)
    ...
    - [ ] Parse keybindings for active mode from current config file and show on footer [#64](https://github.com/deepanchal/dnote-tui/issues/64)
